...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules//.cache//vue-loader","cacheIdentifier":"821e75ee-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/RoundMenu.vue?vue&type=template&id=4952f45e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:['menu', _vm.mode],on:{"click":_vm.toggleMenu}},[(_vm.isDesktop)?_c('span',{staticClass:"menu--half"}):_vm._e(),_c('transition-group',{staticClass:"menu--mid",attrs:{"tag":"div","name":"fade-down","appear":""}},[(true)?_c('div',{key:"hamburger",ref:"hamb",staticClass:"hamburger"}):undefined,(_vm.logo && _vm.mode==='open')?_c('img',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({el:'#home', onDone: _vm.anchorScrollCB, offset:1}),expression:"{el:'#home', onDone: anchorScrollCB, offset:1}"}],key:"logo",staticClass:"logo",attrs:{"src":_vm.logo,"alt":_vm.menu.label,"title":_vm.menu.label}}):_vm._e(),(_vm.mode=='open')?_c('ul',{key:"menu"},_vm._l((_vm.menu),function(item,index){return _c('li',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({el:("#" + (item.anchor)), onDone: _vm.anchorScrollCB, offset: index<=1 ? 1 : 200}),expression:"{el:`#${item.anchor}`, onDone: anchorScrollCB, offset: index<=1 ? 1 : 200}"}],key:item.label,class:[_vm.activeitem===item.anchor ? 'active' : ''],domProps:{"textContent":_vm._s(item.label)}})})):_vm._e()]),(_vm.isDesktop)?_c('span',{staticClass:"menu--half"}):_vm._e()],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/RoundMenu.vue?vue&type=template&id=4952f45e&
...
/* harmony default export */ var RoundMenuvue_type_script_lang_js_ = ({
    ...
    menu: {
      ...
      default: function _default() {
        return [{
          ...
          "label": "Yalnızca Daha Fazla Bilgi",
          "anchor": "moreinfo"
        }];
      }
    },
  ...
  methods: {
    stylusizeJSVariables: function stylusizeJSVariables() {
      ...
      scope.type = "text/css";
      scope.innerHTML = "\n\t\t\t:root {\n\t\t\t\t--color: red;\n\t\t\t\t--item-color: ".concat(this.itemColor, ";\n\t\t\t\t--item-active-color: ").concat(this.itemActiveColor, ";\n\t\t\t\t--item-border-color: ").concat(this.itemBorderColor, ";\n\t\t\t\t--bg-color-closed: ").concat(this.bgColorClosed, ";\n\t\t\t\t--bg-color-open: ").concat(this.bgColorOpen, ";\n\t\t\t}");
    ...
    initAnime: function initAnime() {
      ...
      var _toheight = this.isDesktop ? this.$el.style.height : this.isPortrait ? this.viewportHeight * 1.2 : this.viewportWidth * 1.2,
          _towidth = this.isDesktop ? this.viewportWidth : this.isPortrait ? this.viewportHeight * 1.2 : this.viewportWidth * 1.2; // console.log('_towidth > ', _towidth);
      ...
      if (this.isDesktop) {
        this.menuanim.add({
          ...
          translateY: [{
            ...
            duration: 300 // elasticity: function(el, i, l) {
            // 	return (200 + i * 200);
            // }
        ...
        this.menuanim.add({
          ...
          translateY: [{
            ...
            delay: 0,
            easing: "easeOutQuad",
            duration: 400 // elasticity: function(el, i, l) {
            // 	return (200 + i * 200);
            // }
